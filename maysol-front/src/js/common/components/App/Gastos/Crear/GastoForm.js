...
import { opcionesBanco, opcionesCaja, gastoCaja, options_recuperacion  } from '../../../../utility/constants'
...
const getProveedores = (search) => {
    let params = { search}
    return api.get(`proveedor`, params).catch((error) => {
        console.log("Error al leer cuentas.");
    }).then((data) => {
        data.results.forEach(item => {
...
let GastoForm = props => {
    ...
    const { verProveedor, verComprobante, tipoDocumento, opcionesPago, empresas } = props;
    return(
            ...
            <div className="form-group grid-container">
                <div className="padding-15 p-sm-0 pt-sm-1 pb-sm-1">
                    ...
                    <div className="row">
                        ...
                        <div className="row col-md-6 form-group">
                            <div className="col-md-4">
                                <label htmlFor="categoria">Categoria recuperación:</label>
                            </div>
                            <div className="col-md-8">
                    ...
                    <div className="row">
                        ...
                        <div className="row col-md-6 form-group">
                            <div className="col-md-4">
                                <label htmlFor="persona">Representante:</label>
                            </div>
                            <div className="col-md-8">
                                <Field
                                    name={`persona`}
