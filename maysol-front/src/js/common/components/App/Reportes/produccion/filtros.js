    ...
    return (
        <div className=" borde-superior border-completo mb-3">
            <div className="col-12 row pb-2 pt-3 pl-3 m-0">
                ...
                <div className="col-md-2 form-group">
                        <label className="m-0">Sub empresa</label>
                        <Select
                ...
                <div className="col-md-2 form-group">
                        <label className="m-0">Línea de producción</label>
                        <Select
                            value={this.props.linea}
                            onChange={this.props.setLinea}
                            placeholder="todos"
                            options={this.props.lineas}
                        />
                </div>
            </div>
