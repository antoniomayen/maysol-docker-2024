...
class ToolbarEstadoCuenta extends Component  {
    render() {
        return(
            <div className="col-12 row pb-2 pt-3 pl-3 d-flex justify-content-between">
                ...
                <div className="col-md-3 ml-0 ml-md-4 row form-group mb-1 d-flex justify-content-center justify-content-md-end">
                ...
                <div className="col-md-3 row form-group mb-1 d-flex justify-content-center justify-content-md-end">

                    {
                        this.props.usuario.accesos.administrador && this.props.cambiarFiltro && (
                            <div className="col-md-6 p-0">
                                <label htmlFor="fecha" className="m-0">Empresas</label>
...
export default ToolbarEstadoCuenta;
